...
export default async function ReporteTaconPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">Reporte Tacón</h1>
        <p className="text-muted-foreground">Inventario de materiales de tacón.</p>
      </div>
